...
verifyGreatest q@(QBT.Queue rnk v l r) =  if QBT.pop q == QBT.Empty then True
                                                             else if QBT.pop (QBT.pop q) == QBT.Empty then True
...
testListPopPpeek = TestList [testPopPeek1]
